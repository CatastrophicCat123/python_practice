...
average_temp = round(sum(antarctic_temperatures) / len(antarctic_temperatures), 1)### Insert code here
...
text_value_as_int = int(int_value)# STEP 3: YOUR CODE HERE

# Convert int_value to text
int_value_as_text = str(text_value)# STEP 4: YOUR CODE HERE
